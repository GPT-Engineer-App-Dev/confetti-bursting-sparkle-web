...
**Project**: confetti-bursting-sparkle-web 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: A brilliant confetti webpage 
...
```sh
git clone https://github.com/GPT-Engineer-App-Dev/confetti-bursting-sparkle-web.git
cd confetti-bursting-sparkle-web
npm i
